// File: src/app/api/files/[fileId]/process-combined/route.ts
...
import { createCombinedClaimsProcessor } from '@/services/claims-processing/CombinedClaimsProcessor';
...
export async function POST(
  ...
  try {
    ...
    try {
      ...
      // Initialize combined claims processor
      const processor = createCombinedClaimsProcessor(
        fileId,
        processingId,
      ...
      return NextResponse.json({
        ...
        message: 'Combined processing and enrichment initiated'
      });
    ...
    console.error('Error initiating combined processing:', error);
